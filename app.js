import { game, state } from './src/game.js?t=1782241400388';
import { ui } from './src/ui.js?t=1782241400388';
import { audio } from './src/audio.js?t=1782241400388';
import { p2p } from './src/p2p.js?t=1782241400388';



function startApp() {
    console.log("🚀 [App] 應用程式初始化成功。版本：2.7.0");
    let isUndoing = false;
    let gameSeconds = 0;
